...
test('third test case',() => {
  ...
  // Set commands to move the spacecraft and change its direction
  fireEvent.change(commandsInput, { target: { value: 'f,f,r,r,f,f,l,l' } });
  ...
  // Find the elements displaying the final position and direction
  const finalPositionElement = screen.getByText('Final Position:');
  const positionElement = screen.getByText('Position: (-1, 0, 2)');
  const directionElement = screen.getByText('Direction: W');
...
test('fourth test case',() => {
  ...
  fireEvent.change(initialPositionInput, { target: { value: '-1, 1, 2' } });
  fireEvent.change(initialDirectionInput, { target: { value: 'W' } });
  fireEvent.click(setInitialValuesButton);

  // Set commands to move the spacecraft and change its direction
  fireEvent.change(commandsInput, { target: { value: 'f,r,r,l,r,b,u,f,f,l,b' } });
  ...
  // Find the elements displaying the final position and direction
  const finalPositionElement = screen.getByText('Final Position:');
  const positionElement = screen.getByText('Position: (-2, 1, 4)');
  const directionElement = screen.getByText('Direction: W');
